...
public  class Employee 
{
	...
	*/
	...
	{
		return "FirstName:"+getFirstName()+" "+"LastName:"+getLastName()+" "+"Designation:"+getDesignation()+" "+""
			+ "AcNo: "+getBankDetails().getAccountNumber()+" "+"Bank Name: "+getBankDetails().getBankName();
	}
